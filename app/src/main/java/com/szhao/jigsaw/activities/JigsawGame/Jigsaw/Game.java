...
public class Game {
    ...
    public void initGame(){
        ...
        PuzzlePieceRecyclerViewAdapter viewAdapter = new PuzzlePieceRecyclerViewAdapter(jigsawGameActivity,puzzlePieceArrayList);
        RecyclerView recycler = jigsawGameActivity.getPuzzlePieceRecycler();
        recycler.setAdapter(viewAdapter);
        GameBoard gameBoard = new GameBoard(jigsawGameActivity.getGameLayout(), rows, columns, anchorPoints);
